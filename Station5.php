<?php 
    ...
    $stationsNummer = '5';
    $nameOfStation = 'Arbeitsplatz 5';
    $seitenURL = 'Station5.php';
...
<body>
	...
	<script type="text/javascript">
		...
		ladeEndProdukt(<?php echo $stationsNummer; ?>);
	...
	<div class='grid-container-station'>
		...
		<div class='grid-item name-baustueck'>Endmontage</div>
